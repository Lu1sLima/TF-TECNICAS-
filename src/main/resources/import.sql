...
INSERT INTO VEHICLE (modelo,tipo,marca,placa) values ('fiesta',1,1,'123');
...
INSERT INTO ANUNCIO (user_id,title,description,vehicle_id, preco) values (2,'title test 3','description test 3', 1, 4000);
